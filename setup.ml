...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2b6d48e52bac0b2473a11069fc37f73b) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "http://itrampage.com";
          bugreports = None;
          synopsis =
            "A RDBMS schema migration tool (only PostgreSQL supported)";
          description =
            Some
              [
                 OASISText.Para
                   "It allows generate and execute migration files with SQL or OCaml code."
              ];
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "migrator.ml"})
            ];
     ...
     oasis_digest = Some "\242\138\215\246\177\185>\185G4!eP3\217\190";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
